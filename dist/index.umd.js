(function (global, factory) {
	...
	(factory((global.index = {}),global.reactNative));
	...
	*/
	 ...
	 *
	 */
	var Toast = react_14(function (props, ref) {
	    var _a = react_27(false), showToast = _a[0], setShowToast = _a[1];
	    var _b = react_27(300), delay = _b[0], setDelay = _b[1];
	    // const [toastType, setToastType] = useState('');
	    var _c = react_27(props.message), message = _c[0], setMessage = _c[1];
	    var animatedValue = react_26(new reactNative.Animated.Value(0)).current;
	    react_22(ref, function () { return ({
	    ...
	    return (react.createElement(reactNative.Animated.View, { style: [style.toastWrapper, { opacity: animatedValue }] },
	        react.createElement(reactNative.Text, { style: [style.toastMessage] }, message)));
	});
	var Toast$1 = react.memo(Toast);

	var ToastContext = react.createContext({});
	var ToastProvider = function (props) {
	    var toastRef = react_26(null);
